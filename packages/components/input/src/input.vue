...
<script lang="ts" setup>
  ...
  const shouldIgnoreNextInputAfterComposition = ref(false)
  ...
  const handleInput = async (event: Event) => {
    ...
    if (shouldIgnoreNextInputAfterComposition.value) {
      shouldIgnoreNextInputAfterComposition.value = false
      return
    }
  ...
  const {
    ...
    emit, afterComposition: () => {
      shouldIgnoreNextInputAfterComposition.value = true
    }
  })
